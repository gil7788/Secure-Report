...
*   If `FooTest` has a const non-static data member, then you have to define the
    default constructor *and* construct_sketch_encoders the const member in the initializer
    list of the constructor. (Early versions of `gcc` doesn't force you to
    construct_sketch_encoders the const member. It's a bug that has been fixed in `gcc 4`.)
